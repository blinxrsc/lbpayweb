<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Payment Gateway Transactions') }}
        </h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <!-- Filters -->
                    <form method="GET" action="{{ route('admin.paymentgateway.index') }}" class="mb-6 bg-white rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div class="bg-gray-50 px-4 py-3 border-t border-gray-100 flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <a href="{{ route('admin.paymentgateway.index') }}" class="text-sm text-gray-500 hover:text-gray-700 font-medium px-3 py-2 transition">
                                    Clear All
                                </a>
                            </div>
                            ...
                            <tr class="text-sm">
                                ...
                                <td class="border px-4 py-2">
                                    ...
                                    @if($tx->status === 'completed' || $tx->status === 'failed')
                                        <form method="POST" action="{{ route('admin.paymentgateway.refund', $tx) }}">
                                            @csrf
                                            <button type="submit" 
