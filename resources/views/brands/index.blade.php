                                    ...
                                    <tr>
                                        ...
                                        <td class="border px-4 py-2">
                                            ...
                                            <button type="button" 
                                                ...
                                                title="Delete" 
                                                x-data
                                                x-on:click="$dispatch('open-modal', 'confirm-delete-{{ $brand->name }}')"
                                            >
                                                <x-heroicon-o-trash class="w-5 h-5"/>
                                            </button>
                                            <!-- Modal -->
                                            <x-modal name="confirm-delete-{{ $brand->name }}" maxWidth="2xl">
                                                <div class="p-6">
                                                    <h2 class="text-lg font-medium text-gray-900">
                                                        Delete selected brand ({{ $brand->name }})?
                                                    </h2>
                                                    ...
                                                    <div class="mt-6 flex justify-end gap-3">
                                                        <x-primary-button
                                                            ...
                                                            x-data
                                                            x-on:click="$dispatch('close-modal', 'confirm-delete-{{ $brand->name }}')"
                                                        >
                                                            Cancel
                                                        </x-primary-button>
