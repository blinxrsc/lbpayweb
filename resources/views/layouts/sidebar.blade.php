<div class="p-4">
    ...
    <ul class="space-y-1">
        ...
        <li x-data="{ open: {{ request()->routeIs('admin.device-transactions.*','admin.ewallet.transaction','admin.paymentgateway.*','admin.remote-start-logs.*') ? 'true' : 'false' }} }">
            <button @click="open = !open" 
                class="flex items-center w-full px-3 py-2 text-sm font-medium text-left rounded-md hover:bg-gray-100 transition-colors
                {{ request()->routeIs('admin.device-transactions.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600' }}">
                
                <x-heroicon-m-clipboard-document-list class="w-5 h-5 mr-3 {{ request()->routeIs('admin.device-transactions.*','admin.ewallet.transaction','admin.paymentgateway.*','admin.remote-start-logs.*') ? 'text-blue-600' : 'text-gray-400' }}" />
            ...
            <ul x-show="open" x-cloak class="mt-1 space-y-1 pl-11">
                ...
                @endcan
                @can('transactions.remote-start')
                <li>
                    <x-nav-link href="{{ route('admin.remote-start-logs.index') }}" :active="request()->routeIs('admin.remote-start-logs.*')" class="{{ request()->routeIs('admin.remote-start-logs.*') ? 'text-blue-600' : 'text-gray-400' }}">
                        Remote Start
                    </x-nav-link>
                </li>
                @endcan
        ...
        <!-- Report -->
        @can('reports.manage')
        <li x-data="{ open: {{ request()->routeIs('reports.members.*','reports.maintenance','reports.device-revenue','reports.outlet-revenue') ? 'true' : 'false' }} }">
            <button @click="open = !open" 
                class="flex items-center w-full px-3 py-2 text-sm font-medium text-left rounded-md hover:bg-gray-100 transition-colors
                {{ request()->routeIs('reports.members.*','reports.maintenance','reports.device-revenue','reports.outlet-revenue') ? 'bg-blue-50 text-blue-700' : 'text-gray-600' }}">
                
                <x-heroicon-m-presentation-chart-line class="w-5 h-5 mr-3 {{ request()->routeIs('reports.members.*','reports.maintenance','reports.device-revenue','reports.outlet-revenue')? 'text-blue-600' : 'text-gray-400' }}" />
            ...
            <ul x-show="open" x-cloak class="mt-1 space-y-1 pl-11">
                ...
                @endcan
                @can('reports.outlet-revenue')
                <li>
                    <x-nav-link href="{{ route('reports.outlet-revenue') }}" :active="request()->routeIs('reports.outlet-revenue')" class="{{ request()->routeIs('reports.outlet-revenue')? 'text-blue-600' : 'text-gray-400' }}">
                        Outlet Revenue
                    </x-nav-link>
                </li>
                @endcan
