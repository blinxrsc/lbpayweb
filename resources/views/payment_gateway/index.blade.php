                        ...
                        <table class="min-w-full">
                            <thead>
                                <tr class="text-left text-xs font-medium text-gray-500 uppercase tracking-wide bg-gray-50 border-b border-gray-200">
                                    ...
                                    <th class="px-4 py-2">Terminal ID</th>
                                    <th class="px-4 py-2">App ID</th>
                            ...
                            <tbody>
                                @forelse($settings as $gw)
                                    <tr class="border-b border-gray-100 last:border-0 hover:bg-gray-50">
                                        <td class="px-4 py-2">{{ $gw->merchant_id }}</td>
                                        <td class="px-4 py-2">{{ $gw->terminal_id }}</td>
                                        <td class="px-4 py-2">{{ $gw->app_id }}</td>
                                        <td class="px-4 py-2">{{ $gw->client_id }}</td>
                                        <td class="px-4 py-2">{{ $gw->status == 'active' ? '✅' : '❌' }}</td>
                                        <td class="px-4 py-2">{{ $gw->sandbox }}</td>
