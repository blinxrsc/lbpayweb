                    ...
                    <form method="POST" action="{{ route('customers.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="phone_country_code" value="{{ old('phone_country_code') }}" 
                                    placeholder="60"
                                    class="form-input w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                            </div>
                        ...
                        <div>
                            ...
                            <input id="birthday" type="date" name="birthday"
                                value="{{ old('birthday', $customers->birthday ?? '') }}"
                        ...
                        <div>
                            ...
                            <select name="sign_in" class="form-select w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                                <option value="web" {{ old('sign_in') == 'web' ? 'selected' : '' }}>Web</option>
                                <option value="google" {{ old('sign_in') == 'google' ? 'selected' : '' }}>Google</option>
                                <option value="facebook" {{ old('sign_in') == 'facebook' ? 'selected' : '' }}>Facebook</option>
                            </select>
                        </div>
                        ...
                        <div class="flex items-center justify-end">
                            <x-primary-button class="ml-4">Save Customer</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
